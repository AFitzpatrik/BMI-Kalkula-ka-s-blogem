...
export const metadata = {
  ...
  description: 'Cviky a tréninky zaměřené na quadricepsy.',
}

export default function QuadricepsyPage() {
  return (
      ...
      <div className="flex gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex-1 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-gray-900 mb-4">Tréninky na quadricepsy</h1>
            <p className="text-xl text-gray-600">
              Quadricepsy jsou klíčové pro dřepy, výstupy a sílu nohou.
            </p>
          </div>
